...
const WebHosting = () => {
    ...
    return (
        <>
            ...
            <Header title={"Web Hosting"} sub={"Reliable Web Hosting"} details={"Discover a seamless web hosting experience where making your mark online is as effortless as it is reliable. With our guaranteed dependability, embark on your digital journey right here."} />
            ...
            <div id="get-started" className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-20 mx-auto">
                ...
                <div className="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
                    ...
                    <p className="mt-1 text-gray-600 dark:text-gray-400">
                        ...
                        affordability
                        and choice aligned with your needs. </p>
                </div>
                {/* End Title */}
                ...
                <div className="mt-20 lg:mt-32">
                        ...
                        <section>
                            ...
                            <table className="w-full">
                                ...
                                <tr className="border-t border-gray-200 dark:border-gray-700">
                                    <th className="py-5 px-4 text-sm font-normal text-gray-600 text-left dark:text-gray-400" scope="row">
                                        Open/High/Low/Close
                                    </th>
                                    <td className="py-5 pr-4">
                                        {/* Check */}
                                        <svg className="ml-auto h-7 w-7 text-blue-600" width={16} height={16} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="hidden lg:block">
                        <table className="w-full h-px">
                            ...
                            <thead>
                            <tr>
                                <th className="pb-4 pl-6 pr-6 text-sm font-medium text-gray-800 text-left" scope="col">
                                    <span className="sr-only">Feature by</span>
                                    <span className="dark:text-white">Plans</span>
                                </th>
                                <th className="w-1/4 pb-4 px-6 text-lg leading-6 font-medium text-gray-800 text-center dark:text-white" scope="col">
                                    Starter
                                </th>
                                <th className="w-1/4 pb-4 px-6 text-lg leading-6 font-medium text-gray-800 text-center dark:text-white" scope="col">
                                    Harpy
                            ...
                            <tr>
                                <th className="py-3 pl-6 bg-gray-50 font-bold text-gray-800 text-left dark:bg-slate-800 dark:text-white" colSpan={5} scope="colgroup">
                                    Top Features
                                </th>
                            </tr>
                            <tr>
                                <th className="py-5 pl-6 pr-6 text-sm font-normal text-gray-600 text-left dark:text-gray-400" scope="row">
                                One-click WordPress Installs
                                </th>
                                <td className="py-5 px-6">
                                    {/* Check */}
                                    <svg className="mx-auto h-7 w-7 text-blue-600" width={16} height={16} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M10.2468 5.11462C10.4058 4.91006 10.6862 4.88519 10.8733 5.05907C11.0603 5.23295 11.0831 5.53972 10.9241 5.74428L7.1463 10.6054C6.98484 10.8131 6.69873 10.835 6.5124 10.6539L4.5124 8.70944C4.32894 8.53108 4.31241 8.22382 4.47549 8.02316C4.63856 7.8225 4.91948 7.80443 5.10294 7.98279L6.76331 9.59707L10.2468 5.11462Z" fill="currentColor" />
                                    </svg>
                                    {/* End Solid Check */}
                            ...
                            <tr>
                                ...
                                <td className="py-5 px-6">
                                    {/* Check */}
                                    <svg className="mx-auto h-7 w-7 text-gray-400" width={16} height={16} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path fillRule="evenodd" clipRule="evenodd" d="M4.5 9.00005C4.5 8.8807 4.56773 8.76624 4.68829 8.68185C4.80885 8.59746 4.97236 8.55005 5.14286 8.55005H12.8571C13.0276 8.55005 13.1912 8.59746 13.3117 8.68185C13.4323 8.76624 13.5 8.8807 13.5 9.00005C13.5 9.1194 13.4323 9.23386 13.3117 9.31825C13.1912 9.40264 13.0276 9.45005 12.8571 9.45005H5.14286C4.97236 9.45005 4.80885 9.40264 4.68829 9.31825C4.56773 9.23386 4.5 9.1194 4.5 9.00005Z" fill="currentColor" />
                                    </svg>
                                    {/* End Solid Check */}
                                    <span className="sr-only">Included in Startup</span>
